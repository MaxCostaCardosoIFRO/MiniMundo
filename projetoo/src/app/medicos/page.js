...
import Tabela from "@/components/tabela"; // Certifique-se de que o caminho para o componente Tabela está correto
    ...
    return (
        <div className={styles.container}>
            <div className={styles.containerLista}>
                ...
                {/* Usando o componente Tabela */}
                <Tabela colunas={colunas} dados={medicosFiltrados} loading={loading} />
